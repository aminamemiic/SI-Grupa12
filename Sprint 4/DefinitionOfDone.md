...
User story se smatra završenim kada:
...
- je korisnički interfejs jasan i usklađen sa namjenom funkcionalnosti;
- je funkcionalnost testirana kroz osnovne pozitivne i negativne testne slučajeve;
- je kod pregledan unutar tima i usklađen sa dogovorenom arhitekturom;
